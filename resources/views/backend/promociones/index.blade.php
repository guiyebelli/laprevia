...
<div class="container">
	<div class="row">
		...
		<div class="text-center" >
			...
			<a title="Nuevo usuario" href="{{ action('PromocionesController@create') }}" class="btn btn-primary pull-right"> Nuevo</a>
		</div>
				...
				@if(count($promociones) > 0)
					@foreach($promociones as $promocion)
						<tr>
							...
							<td class="text-right">
								<a href="{{ action('PromocionesController@edit', [$promocion->id]) }}"><span data-toggle="tooltip" data-placement="top" data-title="Editar" class="glyphicon glyphicon-pencil"></span></a>
								<a href="{{ action('PromocionesController@destroy', [$promocion->id]) }}"  data-method="delete" data-confirm="¿Estas seguro que desea eliminar al promocion '{{$promocion}}'?"> <span title="Eliminar" data-toggle="tooltip" data-placement="top" class="glyphicon glyphicon-trash"></span></a>
							</td>
						</tr>
					@endforeach
				@else
